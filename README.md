...
* [`src/clj/breadule/`](src/clj/breadule/): Backend and middleware source files (Clojure,
[Compojure](https://github.com/weavejester/compojure))
* [`src/cljs/breadule/`](src/cljs/breadule/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/breadule/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `breadule` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/breadule/config.cljs) defaults to `true` in
...
```clj
(ns breadule.example
  (:require [breadule.config :as config])
...
```sh
port=2000 java -jar target/breadule.jar
```
